...
namespace Nop.Web.Controllers
{
    public partial class CatalogController : BasePublicController
    {
        ...
        public virtual IActionResult SamSung()
        {
            return View();
        }

        public virtual IActionResult DienThoai()
        {
            return View();
        }

        public virtual IActionResult Laptop()
        {
            return View();
        }

        public virtual IActionResult Tablet()
        {
            return View();
        }

        public virtual IActionResult Sound()
        {
            return View();
        }

        public virtual IActionResult Clock()
        {
            return View();
        }

        public virtual IActionResult SmartHouse()
        {
            return View();
        }

        public virtual IActionResult Accessory()
        {
            return View();
        }

        public virtual IActionResult Old_autumn()
        {
            return View();
        }

        public virtual IActionResult Secondhand_goods()
        {
            return View();
        }

        public virtual IActionResult Sim()
        {
            return View();
        }

        public virtual IActionResult Promotion()
        {
            return View();
        }

        public virtual IActionResult Apple()
        {
            return View();
        }


        public virtual IActionResult IPhone12Series()
        {
            return View();
        }
    }
